...
import 'package:lam3ty/screens/detail_screen/detail_screen.dart';
import 'package:lam3ty/screens/map/map_screen.dart';
...
class AppScreens {
  static final screens = [
    ...
    GetPage(
        name: AppRoutes.onboardScreen, page: () => const OnboardingScreen()),
    GetPage(name: AppRoutes.splashScreen, page: () => SplashScreen()),
    GetPage(
        name: AppRoutes.reservationsScreen, page: () => ReservationsScreen()),
    GetPage(
        name: AppRoutes.requestForgetPassScreen,
        page: () => RequestForgetPassword()),
    GetPage(name: AppRoutes.forgetPassScreen, page: () => ForgetPassword()),
    GetPage(
        name: AppRoutes.changePassScreen, page: () => ChangePasswordScreen()),
    GetPage(
        name: AppRoutes.updateProfileScreen, page: () => UpdateProfileScreen()),
